...
if environment == "local":
    ...
    mentee_response_sheet_url = config["mentee_response_sheet_url"]
    mentors_sheet_url = config["mentors_sheet_url"]
else:
...
mentor_verification_code = st.text_input(
    'Please input your "verification code" from the email. Please note that the "verification code" is case-sensitive.', '')
